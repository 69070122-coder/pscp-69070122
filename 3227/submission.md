...
```text
get input and tell what card is it from the input
input:
card and suit
output:
{cardname} of {suit}
...
```text
i will use .split() then the last digit of the input will be suit and what left will be the card name then i use dict and use if the name in the dict if not it will be number 2-10 and then i use another dict to name all the suit and printf name of suit
```
...
```text
i use the same approach i use dict for naming everything and use if to tell what it s thebn i print it out
```
