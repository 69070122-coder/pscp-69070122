...
```text
get 5 line of input make a frame that depend the length from the longest text
input:
5 row of input
output:
* longest word +4 and *+ text +* for 5 line andthen close the frame
```
...
```text
i use .append ;ist to find max len and use it to tell the  amounty os * i have to print and how much space i have to print between frsame
```
...
```text
i use the same approach i use lst and max(len()) to find the amount of * and " " i have to use
```
