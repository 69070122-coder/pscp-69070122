...
```text
get find out how many vowel in the input text
 
input:
input name
Output:
amount of every vowel if it is more than 0
constraints:
none
```
...
```text
step 1: get input
step 2: make a list of vowel
step 3; make another list to count each vowel
step 4: for loop to go through every letter
step 5: for and if to print out if there are more than 0 vowel in each index of the list
```
...
```text
i use my first approach check each letter 1 by 1
```
