...
```text
โจทย์ต้องการใช้เช็คว่าคะแนนสูงสุดมีโอกาสมากกว่าคะแนนน้อยสุดเกิน 2คะแนนไหม
...
step 1: รับค่ารวม
step 2: รับค่าสูงสุด
step 3; ตรวจระยะห่าง max min โดย มี max 2 อัน แล้วค่า min จะห่างสุดเท่าที่ได้
step 4: เช็คว่า max - min มากกว่า 2 ไหม
step 5: ถ้าใช่พิมพ์ surprising
step 6: ถ้าไม่พิมพ์ Not surprising
```
...
```text
ใช้ตามวิธีแรก ตรวจระยะห่าง max min โดย มี max 2 อัน แล้วค่า min จะห่างสุดเท่าที่ได้ แล้วจึงหาต่อว่ามากกว่า 2 ไหม
```
...
```text
checking if the lowest can be negative
```
