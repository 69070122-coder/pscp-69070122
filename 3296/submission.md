...
```text
รับค่าสี ทั้ง2 ตัวแล้วรวมกันหาร2ปัดเศษทิ้ง
input: 2 line tof number saperate by ' '
output: 1 line seperate by " "
```
...
```text
i use input.split and just add up first num from each row and // 2 that it
```
...
```text
i use the same approach i use just split and //
```
