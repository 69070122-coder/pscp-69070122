...
```text
โจทย์ให้รับค่าจำนวนเต็มบวกไปเรื่อยๆจนกว่าจะใส่ -1 จากนั้นนำไปจัดกลุ่มโดยต่อกันด้วย - 
input;
จำนวนเต็มบวก และหยุด loop ด้วย -1
output:
กลุ่มของตัวเลขที่เชื่อมกันด้วย - ex 1-10,12
```
...
```text
เก็บตัวเลขรับเข้ามาใน list และตรวจสอบทีละตัวว่าตัวเลขในปัจจุบันต่อเนื่องกันตัวก่อนหน้าหรือไม่แล้วคุ่นแต่ละช่วงด้วย ,
```
...
```text
ใช้วิธีแรกแต่โดยเช็คทีละตัวว่าต่อเนื่องกันไหมแล้วคั่นด้วย,
```
